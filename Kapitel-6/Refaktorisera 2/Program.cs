...
static void AngeTeckenAttRitaMed(int storlek)
{
    Console.Write("Ange ett tecken att rita med: ");
        char tecken = Console.ReadKey().KeyChar;
        Console.WriteLine();
...
static void Main(string stojd)
{
    Console.Write($"Ange {stojd}: ");
        string input = Console.ReadLine();
        int storlek;
        while (!int.TryParse(input, out storlek))
        {
